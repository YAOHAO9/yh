go run example.go -s="dwc" -i="connector-1" -k="connector" -H="127.0.0.1" -P="3111" -c -t="ksYNdrAo" -l="1" --zhost="127.0.0.1" --zport="2181" &
go run example.go -s="dwc" -i="connector-2" -k="connector" -P="3112" -c -t="ksYNdrAo" &
